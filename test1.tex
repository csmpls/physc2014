...
\abstract{Physiological computing applications rely on time series sensor data, which vary widely between users and change over time. Application designers face a tradeoff between computational complexity, calibration time, and classification accuracy. We describe a novel quantization technique for electroencephalograph (EEG) signals, which we find increases the computational speed associated with training a machine-learning based classifier without significant detriment to the system's accuracy. We test this technique on a brain-computer interface (BCI) that uses a single EEG sensor, and find that an opportunistic calibration strategy can achieve high accuracy in 86.6\% of subjects with under five minutes of training, and in 100\% of subjects with under 15 minutes. We discuss implications for the design of consumer-ready BCI and other physiological computing applications.}
