...
% How can we characterize the tradeoff between computational complexity and classification accuracy at the signal processing step? Is it possible to achieve user calibration on the order of minutes rather than hours or days?
